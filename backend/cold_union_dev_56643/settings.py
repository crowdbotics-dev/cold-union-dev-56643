"""
Django settings for cold_union_dev_56643 project.
...
ROOT_URLCONF = 'cold_union_dev_56643.urls'
...
WSGI_APPLICATION = 'cold_union_dev_56643.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_union_dev_56643 API",
    "DESCRIPTION": "API documentation for cold_union_dev_56643 App",
    "VERSION": "v1",
}
